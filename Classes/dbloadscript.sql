...
INSERT INTO `g3t4`.`Users` (Name, Username, Password, UserType, Designation, Department) VALUES ('Sarah',  'Sara', 'sarah_pass', '1', 'designee', 'engineerina');
...
INSERT INTO `g3t4`.`quiz` (Quiz_ID, Time_Limit) VALUES ('1','15');
INSERT INTO `g3t4`.`quiz` (Quiz_ID, Time_Limit) VALUES ('2','60');

DROP TABLE IF EXISTS Question;
CREATE TABLE Question (
	Quiz_ID int not null, -- each quiz got its own unique id
    ...
    Question_Type int not null, -- 1: MCQ, 2: T/F, 3: SHORTANSWER?
...
INSERT INTO `g3t4`.`question` (Quiz_ID, Question_ID, Question_Name, Question_Type, Answer) VALUES ('1', '1', 'What is x * y', '1', '1000'); -- changed to fit MCQ_Options
INSERT INTO `g3t4`.`question` (Quiz_ID, Question_ID, Question_Name, Question_Type, Answer) VALUES ('1', '2', 'printf(\"hihi\")', '3', 'hihi');
INSERT INTO `g3t4`.`question` (Quiz_ID, Question_ID, Question_Name, Question_Type, Answer) VALUES ('2', '3', 'WAD2ishard', '2', 'T');
...
INSERT INTO `g3t4`.`course_class` (Course_ID, Class_ID, Trainer_ID, Class_Start, Class_End, Size_Limit, Reg_Start, Reg_End, Final_Quiz_ID) VALUES ('ES102', '1', '2', '2021-09-29', '2021-10-20', '40', '2021-09-10', '2021-09-13', 1);
INSERT INTO `g3t4`.`course_class` (Course_ID, Class_ID, Trainer_ID, Class_Start, Class_End, Size_Limit, Reg_Start, Reg_End, Final_Quiz_ID) VALUES ('ES102', '2', '2', '2021-10-27', '2021-11-20', '35', '2021-10-20', '2021-10-15', 1);
INSERT INTO `g3t4`.`course_class` (Course_ID, Class_ID, Trainer_ID, Class_Start, Class_End, Size_Limit, Reg_Start, Reg_End, Final_Quiz_ID) VALUES ('IS216', '1', '4', '2021-10-27', '2021-11-20', '40', '2021-10-20', '2021-10-15', 1);
...
INSERT INTO `g3t4`.`sections` (Course_ID, Class_ID, Section_ID, Description, Quiz_ID, Course_Material) VALUES ('ES102', '1', '1', 'Intro to Programming Part 2', '1', 'Part 2 Lecture Materials');
INSERT INTO `g3t4`.`sections` (Course_ID, Class_ID, Section_ID, Description, Quiz_ID, Course_Material) VALUES ('IS216', '1', '1', 'WAD Part 1', '2', 'Part 1 Lecture Materials');

DROP TABLE IF EXISTS MCQ_Options;
-- if mcq, otherwise question wont have any rows here??? or one row?
CREATE TABLE MCQ_Options (
	Quiz_ID int not null, -- one row for each question option
...
INSERT INTO `g3t4`.`mcq_options` (Quiz_ID, Question_ID, Question_Option) VALUES ('1', '1', '33');
INSERT INTO `g3t4`.`mcq_options` (Quiz_ID, Question_ID, Question_Option) VALUES ('1', '1', '55');
INSERT INTO `g3t4`.`mcq_options` (Quiz_ID, Question_ID, Question_Option) VALUES ('1', '1', '1000'); -- correct answer
INSERT INTO `g3t4`.`mcq_options` (Quiz_ID, Question_ID, Question_Option) VALUES ('1', '1', '100');
INSERT INTO `g3t4`.`mcq_options` (Quiz_ID, Question_ID, Question_Option) VALUES ('2', '3', 'T'); -- new line for testing
...
CREATE TABLE Engineer_Course_Enrolment (
    ...
    Course_Status varchar(255), # registered / enrolled / completed
...
INSERT INTO `g3t4`.`engineer_course_enrolment` (Course_ID, Class_ID, User_ID, Course_Status) VALUES ('ES102', '1', '1', 'Enrolled');
INSERT INTO `g3t4`.`engineer_course_enrolment` (Course_ID, Class_ID, User_ID, Course_Status) VALUES ('IS216', '1', '3', 'Completed');
...
CREATE TABLE Engineer_Course_Section (
    ...
    User_ID int not null,
    Section_ID int not null,
    Section_Status varchar(255), -- pass/(fail) depending on score, null if nothing yet
    Quiz_ID int not null, 
...
INSERT INTO `g3t4`.`engineer_course_section` (Course_ID, Class_ID, User_ID, Section_ID, Section_Status, Quiz_ID) VALUES ('ES102', '1', '1', '1', 'complete', '1');
INSERT INTO `g3t4`.`engineer_course_section` (Course_ID, Class_ID, User_ID, Section_ID, Section_Status, Quiz_ID) VALUES ('IS216', '1', '3', '1', 'incomplete', '2');
...
INSERT INTO `g3t4`.`Quiz_User` (Quiz_ID, Question_ID, User_ID, User_Answer) VALUES ('1', '1', '1', '3');
...
CREATE TABLE BadgeDB (
  Badge_ID varchar(15) not null,
  User_ID INT NOT NULL,
  Badge_Name VARCHAR(45) NOT NULL,
  Badge_Info VARCHAR(225) NOT NULL, 
  PRIMARY KEY (Badge_ID, User_ID),
  FOREIGN KEY (Badge_ID) REFERENCES Courses(Course_ID),
  FOREIGN KEY (User_ID) REFERENCES Users(User_ID)
)engine=innoDB;


DROP TABLE IF EXISTS Course_Eligibility;
CREATE TABLE Course_Eligibility (
    Course_ID varchar(15) not null,
    User_ID int not null,
    Eligibility varchar(255), #Ineligible or Eligible
...
INSERT INTO `g3t4`.`Course_Eligibility` (Course_ID, User_ID, Eligibility) VALUES ('IS111', '1', 'Eligible');
INSERT INTO `g3t4`.`Course_Eligibility` (Course_ID, User_ID, Eligibility) VALUES ('IS111', '6', 'Ineligible');